...
export const VerifyEmail = ({
    ...
    >
        <Html>
            ...
            <Preview>Checkout time is approaching</Preview>
            ...
            <Body className="font-lato">
                <Container>
                    ...
                    <Section className="px-[20px] pt-[10px] pb-[20px]">
                        ...
                        {/* =====Header text====== */}
                        <Section>
                            <Heading className="font-montserrat text-black text-[20px] leading-[30px]"> Check-Out time is approaching
                            </Heading>
                        </Section>
                        ...
                        <Section>
                            <Text className="font-lato text-[14px] text-[#4b5563] leading-[23.8px]">
                                ...
                                As your departure approaches, we wanted to give you a
                                gentle reminder that you have 15 minutes left before
                                the scheduled checkout time.
                            </Text>
                        </Section>
                        ...
                        <Section className="font-lato">
                            <Row>
                                <Heading as="h3" className="font-lato text-[14px] text-black">Quick check-out tips</Heading>
                                <ul>
                                    <li>
                                        <Text className="text-paragraph font-lato">
                                            Please double-check that you have all your
                                            personal belongings.
                                        </Text>
                                    </li>
                                    <li>
                                        <Text className="text-paragraph font-lato">
                                            If you need a bit more time to prepare for
                                            departure, please contact and discuss with your
                                            host.
                                        </Text>
                                    </li>
                                </ul>
