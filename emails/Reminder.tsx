...
export const VerifyEmail = ({
    ...
    >
        <Html>
            ...
            <Preview>Upcoming booking reminder</Preview>
            ...
            <Body className="font-lato">
                <Container>
                    ...
                    <Section className="px-[20px] pt-[10px] pb-[20px]">
                        ...
                        {/* =====Header text====== */}
                        <Section>
                            <Heading className="font-montserrat text-black text-[20px] leading-[30px]"> Upcoming booking reminder
                            </Heading>
                        </Section>
                        ...
                        <Section>
                            <Text className="font-lato text-[14px] text-[#4b5563] leading-[23.8px]">
                                ...
                                We are looking forward to welcoming you. As your visit
                                approaches, we wanted to remind you of your upcoming
                                booking.
                            </Text>
                        </Section>

                        <Section>
                            <Heading className="font-[16px] text-[16px] leading-[24px] text-black font-lato"> Confirmation Details</Heading>
                        </Section>
                        ...
                        <Section className="">
                            <Row>
                                <Heading as="h3" className="font-lato text-black text-[14px] leading-[17px]">What's next?</Heading>
                                <Text className="text-paragraph font-lato text-[14px]">
                                    For details of your booking and arrival instructions,
                                    view the booking details below or contact the host for
                                    any inquiries about the space.
                                </Text>
                            </Row>
                            <Row>
